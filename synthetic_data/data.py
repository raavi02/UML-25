...
generate_pose_csv("CamA_GT", "data/CamA_GT.csv", noisy=False, base_coords=base_cam1)
generate_pose_csv("CamB_GT", "data/CamB_GT.csv", noisy=False, base_coords=base_cam2)

# --- Generate predictions (GT + noise) ---
generate_pose_csv("CamA_pred", "data/CamA_pred.csv", noisy=True, base_coords=base_cam1)
generate_pose_csv("CamB_pred", "data/CamB_pred.csv", noisy=True, base_coords=base_cam2)
